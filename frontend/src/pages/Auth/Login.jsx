          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div>
              ...
              <div className='relative'>
                ...
                <button
                  ...
                  >
                    {formState.showPassword ? <EyeOff className='w-5 h-5 cursor-pointer' /> : <Eye className='w-5 h-5 cursor-pointer' />}
                </button>
              </div>
              {formState.error.password && (
                <p className='text-red-500 text-sm mt-1 flex items-center'>
                  <AlertCircle className='w-4 h-4 mr-1' /> {formState.error.password}
                </p>
              )}
            </div>
            ...
            {formState.error.submit && (
              ...
              <p className='text-red7500 text-sm flex items-center'>
                <AlertCircle className='w-4 h-4 mr-2' /> {formState.error.submit}
              </p>
              </div>
            )}
